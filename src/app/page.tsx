...
export default function SplashScreen() {
  ...
  return (
    <main className="h-screen px-4 py-8 text-center bg-[#f0f4f3] text-black space-y-6">
      ...
      <Image src="/undraw_done_checking_re_6vyx 1.png" alt="Logo" width={254} height={194} className='mx-auto mt-[210px]'/>
      
      <h1 className="text-[18px] font-bold text-center mt-20 mb-4">Gets things with TODs</h1>
      <p className='text-[13px] mx-auto text-center w-[203px] text-black/80 mb-28'>Lorem ipsum dolor sit amet consectetur. Eget sit nec et euismod. Consequat urna quam felis interdum quisque. Malesuada adipiscing tristique ut eget sed.</p>
