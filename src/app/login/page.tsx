...
export default function LoginPage() {
  ...
  return (
    <main className="px-4 py-8 space-y-6">
          ...
          <Image src="/undraw_back_to_school_inwc 1.png" alt="Logo" width={184.44} height={138} className='inline-block mx-auto my-12'/>

        <input type="email" placeholder="Enter your Email" value={email} onChange={e => setEmail(e.target.value)} />
        <input type="password" placeholder="Enter Password" value={password} onChange={e => setPassword(e.target.value)} />

        <p className='text-[13px] mx-auto w-[203px] text-[#50C2C9] mt-4 mb-14 px-6'>Forget password ?</p>
        
        <button onClick={handleLogin}>
        Login
      </button>

        <p className="text-center text-[16px] pb-8">
